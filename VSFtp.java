...
public class VSFtp {
    ...
    public VSFtp(int vstype, String filename) {     // VSSend uses this constructor to instantiate buffer, data length and file
        byte[] encodedName = filename.getBytes(StandardCharsets.UTF_8);
        alloc(vstype, MINLEN + encodedName.length);
        byteBuffer.put(encodedName);    // This method transfers the entire content of the given source byte array into this buffer
